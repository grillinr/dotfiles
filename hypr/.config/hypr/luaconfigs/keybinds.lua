...
bind(main_mod .. " + B", hl.dsp.exec_cmd(BROWSER))
bind(main_mod .. " + E", hl.dsp.exec_cmd("kitty fish -ic y"))
bind(main_mod .. " + N", hl.dsp.exec_cmd("kitty fish -ic nvim"))
bind(main_mod .. " + SPACE", hl.dsp.exec_cmd("hyprlauncher"))
...
bind(main_mod .. " + SHIFT + N", hl.dsp.exec_cmd('kitty fish -ic "nq"'))
